...
ROSTER = {
    "isagi":     ("Yoichi Isagi",      "SSR", (4, 5, 3, 6, 3), "Spatial Hunter"),
    "rin":       ("Rin Itoshi",        "SSR", (6, 4, 4, 5, 4), "The Complete Striker"),
    "sae":       ("Sae Itoshi",        "SSR", (4, 6, 4, 5, 4), "Spain's Genius"),
    "kaiser":    ("Michael Kaiser",    "SSR", (6, 3, 4, 4, 6), "The Emperor"),
    "nagi":      ("Seishiro Nagi",     "SSR", (5, 3, 6, 4, 2), "Raw Talent"),
    "shidou":    ("Ryusei Shidou",     "SSR", (6, 2, 5, 4, 2), "Goal Monster"),
    "barou":     ("Shoei Barou",       "SR",  (5, 3, 4, 3, 3), "The King"),
    "chigiri":   ("Hyoma Chigiri",     "SR",  (3, 3, 6, 3, 2), "Pure Speed"),
    "bachira":   ("Meguru Bachira",    "SR",  (3, 4, 6, 3, 2), "Monster's Partner"),
    "reo":       ("Reo Mikage",        "SR",  (4, 4, 3, 4, 3), "All-Rounder"),
    "hiori":     ("Yo Hiori",          "SR",  (3, 5, 3, 4, 3), "Quiet Shadow"),
    "otoya":     ("Eita Otoya",        "SR",  (3, 4, 5, 3, 3), "Opportunist"),
    "karasu":    ("Tabito Karasu",     "SR",  (3, 5, 3, 5, 3), "Field Brain"),
    "yukimiya":  ("Kenyu Yukimiya",    "SR",  (4, 4, 4, 3, 4), "The Prince"),
    "kunigami":  ("Rensuke Kunigami",  "SR",  (5, 3, 3, 3, 5), "The Hero"),
    ...
    "iemon":     ("Kenta Igarashi",    "R",   (2, 4, 3, 4, 3), "Midfield Anchor"),
    "naruhaya":  ("Asahi Naruhaya",    "R",   (3, 3, 4, 3, 3), "Agile"),
    "kurona":    ("Ranze Kurona",      "R",   (2, 3, 5, 3, 3), "The Apprentice"),
    "tokimitsu": ("Aoshi Tokimitsu",   "R",   (5, 1, 3, 4, 3), "Unchained Power"),
    "wanima_a":  ("Keisuke Wanima",    "N",   (2, 2, 4, 3, 2), "Twin One"),
    "wanima_j":  ("Jyngo Wanima",      "N",   (2, 4, 2, 3, 2), "Twin Two"),
    "igaguri":   ("Gurimu Igaguri",    "N",   (2, 3, 2, 4, 2), "The Tryhard"),
    "hyoma_k":   ("Okuhito Iemon",     "N",   (1, 3, 2, 5, 2), "The Support"),
    "yuki":      ("Sousuke Yuki",      "N",   (2, 3, 3, 3, 2), "Quiet"),
